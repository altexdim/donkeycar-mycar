...
GYM_CONF = { "body_style" : "car01", "body_rgb" : (0, 255, 0), "car_name" : "Dmitry Ananyev", "font_size" : 20} # body style(donkey|bare|car01) body rgb 0-255
...
# xp
AI_THROTTLE_MULT = 0.8              # this multiplier will scale every throttle value for all output from NN models
